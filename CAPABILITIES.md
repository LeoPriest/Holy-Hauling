...
- Date: 2026-06-19
- By: Claude (crew agenda + completed-jobs view + period availability + calendar-sync fix + self-learning roadmap items 1-3)
- Tests: **337 passed, 0 failed** (full backend suite, 2026-06-19; crew agenda is frontend-only). Frontend `tsc --noEmit` + `npm run build` pass.
